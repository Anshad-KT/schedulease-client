...
//title,host,dateOptions,duration,guests, isCompleted,timeOptions
  const submitData = async() =>{
    setShowModal(false)
    console.log({title:eventName,guests:emails,host:"Anshad Kt",dateOptions:value,duration:selectedDuration,isCompleted:false,timeOptions:selectedTimes});
    let user = localStorage.getItem("user")
   // Ensure that the user is not null before attempting to parse and use it
if (user) {
  // Parse the user JSON representation
  const parsedUser = JSON.parse(user);

  // Access the email property from the parsed user
  const userEmail = parsedUser.email;
const obj = emails.map((item)=>{
   
})
  // Assuming addMeeting is a function that adds a meeting
  ...
  console.log(yourFirstDate,yourSecondDate,"lllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll");
